...
const kSSNColor = Color(0XFF0051977);
const kDarkssn = Color(0XFF03036A);
const kInactiveColor = Color(0XFFE4ECF3);
const bg = Color(0XFFc5e4ff);
const food_Category_List = [
  ...
  {
    "imagePath": "images/tikka-masala.png",
    "name": "Gravies",
  },
  {
